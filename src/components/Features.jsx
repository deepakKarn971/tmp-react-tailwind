...
const FeatureCard = ({ icon, title, description, index }) => {
  ...
  return (
    <div 
      ref={cardRef}
      className="glass p-8 rounded-2xl card-hover opacity-0"
  ...
  const features = [
    {
      ...
      description: "User-centered interfaces that feel natural and effortless to use, putting function first without sacrificing form."
    },
    {
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" /></svg>,
      title: "Thoughtful Details",
      description: "Every element has been carefully considered, from subtle animations to precise spacing and perfect alignment."
    },
    {
      ...
      description: "Smooth transitions and micro-interactions create a cohesive and delightful user journey throughout the interface."
    },
    {
      ...
      description: "Perfectly optimized for all devices, from mobile to desktop, with layouts that adapt beautifully to any screen size."
    },
    {
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>,
      title: "Performance First",
      description: "Optimized for speed and efficiency, ensuring smooth animations and instant responses to user interactions."
    },
    {
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>,
      title: "Accessibility Built-in",
      description: "Designed for everyone, with careful attention to accessibility standards and inclusive user experiences."
    }
  ];
      ...
      <div className="container-padding">
        <div className="text-center mb-16">
          ...
          <p className="subtitle-animation max-w-2xl mx-auto text-foreground/70 text-lg opacity-0" style={{ animationDelay: '0.2s' }}>
            Every feature has been thoughtfully crafted to improve your experience and make interaction effortless.
          </p>
        </div>
